...
###############################################################################
"""
Script for autonomous collect of different statistics.
"""
###############################################################################
...
def form_statistics(stat):
    ...
    verbose_stat_str += "\n=================================\n"
    return verbose_stat_str


def print_statistics(stat, task_threads, num_jobs):
    any_alive = True
    while any_alive:
        verbose_stat_str = form_statistics(stat)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--work-dir", dest="work_dir", default="collect_stats_dir", type=str,
                        help="Directory, which is used for statistics' collection.")
    ...
    parser.add_argument("--stat-log-file", dest="stat_log_file", default="collect_stats_res.log", type=str,
