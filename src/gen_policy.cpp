...
void GenPolicy::init_from_config () {
    ...
    int_special_const_prob.emplace_back(Probability<ConstPattern::IntSpecialConst>(ConstPattern::IntSpecialConst::Zero, 10));
    int_special_const_prob.emplace_back(Probability<ConstPattern::IntSpecialConst>(ConstPattern::IntSpecialConst::One, 10));
    int_special_const_prob.emplace_back(Probability<ConstPattern::IntSpecialConst>(ConstPattern::IntSpecialConst::Two, 10));
    int_special_const_prob.emplace_back(Probability<ConstPattern::IntSpecialConst>(ConstPattern::IntSpecialConst::Three, 10));
    int_special_const_prob.emplace_back(Probability<ConstPattern::IntSpecialConst>(ConstPattern::IntSpecialConst::Four, 10));
    int_special_const_prob.emplace_back(Probability<ConstPattern::IntSpecialConst>(ConstPattern::IntSpecialConst::Eight, 10));
    int_special_const_prob.emplace_back(Probability<ConstPattern::IntSpecialConst>(ConstPattern::IntSpecialConst::Sixteen, 10));
    int_special_const_prob.emplace_back(Probability<ConstPattern::IntSpecialConst>(ConstPattern::IntSpecialConst::MAX_INT_SPECIAL_CONST, 10));
    rand_val_gen->shuffle_prob(int_special_const_prob);
    fp_special_const_prob.emplace_back(Probability<ConstPattern::FPSpecialConst>(ConstPattern::FPSpecialConst::Quarter, 25));
    fp_special_const_prob.emplace_back(Probability<ConstPattern::FPSpecialConst>(ConstPattern::FPSpecialConst::Half, 25));
    fp_special_const_prob.emplace_back(Probability<ConstPattern::FPSpecialConst>(ConstPattern::FPSpecialConst::One, 25));
    fp_special_const_prob.emplace_back(Probability<ConstPattern::FPSpecialConst>(ConstPattern::FPSpecialConst::Two, 25));
    rand_val_gen->shuffle_prob(fp_special_const_prob);
