...
OPT=-O3
LDFLAGS=-L./ -std=c++11
LIBSOURCES=type.cpp variable.cpp expr.cpp stmt.cpp gen_policy.cpp sym_table.cpp master.cpp loop_types.cpp loop_expr.cpp namegen.cpp loop_stmt.cpp interface.cpp
...
HEADERS=probability.h type.h variable.h ir_node.h expr.h stmt.h gen_policy.h sym_table.h master.h typedefs.h loop_types.h namegen.h loop_stmt.h interface.h
