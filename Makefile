...
OPT=-O3
LDFLAGS=-L./ -std=c++14
LIBSOURCES=type.cpp variable.cpp expr.cpp stmt.cpp gen_policy.cpp sym_table.cpp program.cpp options.cpp cfg_gen.cpp
...
HEADERS=type.h variable.h ir_node.h expr.h stmt.h gen_policy.h sym_table.h program.h options.h cfg_gen.h
